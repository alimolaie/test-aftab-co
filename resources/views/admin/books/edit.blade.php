                                        ...
                                        <ul class="droplet-dropdown bookmark-dropdown">
                                            ...
                                            <li>
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-center"><i data-feather="books"></i></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 breadcrumb-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">کتاب</li>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                {!! Form::text('name', $book->name, array('placeholder' => 'لطفا نام را وارد کنید','class' => 'form-control')) !!}
                                            </div>
                                        </div>


                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">انتخاب ژانر</label>
                                            <div class="col-sm-9">
                                                {!! Form::select('genre',[""=>"ژانر را انتخاب کنید","1"=>"رمان","2"=>"درسی"], array('class' => 'form-control')) !!}
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">جزئیات</label>
                                            <div class="col-sm-9">
                                                {!! Form::textarea('details',$book->details,['class'=>'form-control', 'rows' => 2, 'cols' => 40]) !!}                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">شابک</label>
                                            <div class="col-sm-9">
                                                {!! Form::text('isbn',$book->isbn, array('placeholder' => 'لطفا شابک را وارد کنید','class' => 'form-control')) !!}
                                            </div>
                                        </div>

                                        <label class="col-sm-3 col-form-label">تصویر شاخص</label>
                                        <div class="col-sm-9">
                                            {!! Form::file('images', array('class' => 'form-control-file','multiple')); !!}
                                        </div>
                                        <br>
                                        <br>
                                        <img src="{{asset('uploads/books/'.$book->images)}}" width="80" height="80">
                                    </div>
                                </div>
                            </div>
                        </div>
