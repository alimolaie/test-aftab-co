                        ...
                        <ul class="onhover-show-div droplet-dropdown">
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-6 droplet-main"><i data-feather="books"></i><span class="d-block">مخاطب</span></div>
                                ...
                                <table class="table table-xl">
                                    ...
                                    @foreach ($data as $key => $book )
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('uploads/books/'.$book->images)}}" alt="image post" width="40" height="40"></td>
                                            <td>
                                                {{$book->isbn}}
                                            </td>
                                            <td>
                                                <form action="{{ route('books.destroy',$book->id) }}" method="POST">
                                                    ...
                                                    <a href="{{ route('books.edit',$book->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
